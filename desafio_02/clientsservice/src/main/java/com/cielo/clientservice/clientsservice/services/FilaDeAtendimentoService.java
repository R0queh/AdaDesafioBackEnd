...
public class FilaDeAtendimentoService {
    ...
    @Autowired
    public FilaDeAtendimentoService(PessoaJuridicaRepository pessoaJuridicaRepository, PessoaFisicaRepository pessoaFisicaRepository, ClienteDTOMapper clienteDTOMapper) {
